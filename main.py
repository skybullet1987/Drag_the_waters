...
class SimplifiedCryptoStrategy(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.max_position_pct   = self._get_param("max_position_pct", 0.35)  # 20% of portfolio per position
        ...
        self._min_trade_capital = 5  # Minimum $300 per trade
        ...
        self.max_participation_rate = 0.5   # Max 2% of daily dollar volume per position
