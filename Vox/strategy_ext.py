# ── strategy_ext.py: ruthless subpackage + ruthless_v2 shim ─────────────────
import math
...
def compute_apex_size(
    ...
    """
    try:
        from core import APEX_BASE_ALLOC as _ba, APEX_MAX_GROSS as _mg
    except ImportError:
        _ba, _mg = 0.20, 2.0
...
# ===============================================================================
# ruthless_v2 shim (__all__ + re-exports)
# ===============================================================================
